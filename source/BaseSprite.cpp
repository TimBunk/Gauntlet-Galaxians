...
namespace NHTV
{
	...
	void BaseSprite::Draw(unsigned int a_uiProgram)
	{
		...
		glUniformMatrix4fv(ModelID, 1, false, glm::value_ptr(GetModelMatrix()));
	...
	void BaseSprite::GetAngle(float & a_angle)
	{
		a_angle = m_m4Matrix[2][2];
	}
	...
	void BaseSprite::GetUvScale(glm::vec2 & a_v2UvScale)
	{
		a_v2UvScale = m_uvScale;
	}

	void BaseSprite::GetUvOffset(glm::vec2 & a_v2UvOffset)
	{
		a_v2UvOffset = m_uvOffset;
	}

	glm::mat4 BaseSprite::GetModelMatrix()
	{
		glm::mat4 m4Scale;
