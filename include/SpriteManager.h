...
namespace NHTV
{
	...
	public:
		...
		//////////////////////////////////////////////////////////////////////////
		void Draw(unsigned int a_uiShaderID, int a_maxTextureUnit);
		//////////////////////////////////////////////////////////////////////////
		...
		void			GetAngle(unsigned int a_uiSpriteID, float& a_angle);
		...
		void			SetSpriteOrigin(unsigned int a_uiSpriteID, glm::vec2& a_V2SpriteOrigin);
		void			GetSpriteOrigin(unsigned int a_uiSpriteID, glm::vec2& a_V2SpriteOrigin);

		BaseSprite*		GetBaseSprite(unsigned int a_uiSpriteID);
		const NHTV::Vertex*	GetVertexData(unsigned int a_uiSpriteID);
	protected:
	...
	private:
		void Draw(std::vector<Vertex>& vertices, std::vector<ShaderData>& allShaderData);
